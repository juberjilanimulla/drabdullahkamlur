...
const adminmediaimageRouter = Router();

adminmediaimageRouter.post("/:id", (req, res) => {
  upload(req, res, async (err) => {
    ...
    try {
      ...
      const s3Key = `mediaimages/${fileName}`;
      ...
      return successResponse(res, "Image uploaded successfully", media);
    } catch (error) {
...
export default adminmediaimageRouter;
